...
let oldDemoToken: string | undefined;
let tmpHome = "";
...
describe("ACU Router demo reliability", () => {
  beforeAll(async () => {
    ...
    oldDemoToken = process.env.DEMO_ACCESS_TOKEN;
  ...
  afterAll(async () => {
    ...
    if (oldDemoToken === undefined) delete process.env.DEMO_ACCESS_TOKEN;
    else process.env.DEMO_ACCESS_TOKEN = oldDemoToken;
