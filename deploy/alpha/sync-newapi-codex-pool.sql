UPDATE channels
SET models = 'acu-auto,claude-opus-4-8,claude-sonnet-5,deepseek-v4-flash,gemini-2.5-flash,glm-5.1,glm-5.2,gpt-5.4-mini,gpt-5.5,gpt-5.6-luna,gpt-5.6-sol,gpt-5.6-terra,kimi-k2.6,kimi-k2.7-code',
    header_override = '{"*":""}'
WHERE id = 1 AND name = 'ACU Responses Alpha';

INSERT INTO abilities ("group", model, channel_id, enabled, priority, weight, tag)
SELECT 'default', model_id, 1, true, 0, 0, 'acu-router'
FROM unnest(ARRAY['acu-auto','claude-opus-4-8','claude-sonnet-5','deepseek-v4-flash','gemini-2.5-flash','glm-5.1','glm-5.2','gpt-5.4-mini','gpt-5.5','gpt-5.6-luna','gpt-5.6-sol','gpt-5.6-terra','kimi-k2.6','kimi-k2.7-code']) AS model_id
...
WHERE model_name IN ('acu-auto','claude-opus-4-8','claude-sonnet-5','deepseek-v4-flash','gemini-2.5-flash','glm-5.1','glm-5.2','gpt-5.4-mini','gpt-5.5','gpt-5.6-luna','gpt-5.6-sol','gpt-5.6-terra','kimi-k2.6','kimi-k2.7-code')
  AND deleted_at IS NULL;

UPDATE tokens
SET model_limits_enabled = true,
    model_limits = 'acu-auto,claude-opus-4-8,claude-sonnet-5,deepseek-v4-flash,gemini-2.5-flash,glm-5.1,glm-5.2,gpt-5.4-mini,gpt-5.5,gpt-5.6-luna,gpt-5.6-sol,gpt-5.6-terra,kimi-k2.6,kimi-k2.7-code'
